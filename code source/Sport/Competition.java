...
public class Competition{
	...
	// Necessaire pour le MAJ d'un Arbitre et pour eviter la redondance lors de saisie 
	...
	// Necessaire pour le MAJ d'un equipe, l'affichage et pour eviter la redondance lors de saisie 
	...
	// Necessaire pour le MAJ d'un Entraineur et pour eviter la redondance lors de saisie 
	...
	// On avait un probleme lors du classement des equipes selon le nombre de points en utilisant l'ArrayList
	// La probleme est resolu en utilisant une ArrayList auxiliare pour le classement dernier
	// Cette methode est dedie pour verifier si un equipe est deja classe (existe) dans l'ArrayList auxiliare contenant les equipes classes
