...
public class Match {
    ...
    // Le nombre de buts de chaque equipes est calcule arbitrerement mais sans depasser 10 
    ...
    // Constructeur surcharge si on veut saisir le nombre de buts par le clavier
    public Match(Equipe equipe1,Equipe equipe2,int e1b,int e2b, Arbitre arbitre,String tour) {
        ...
        this.arbitre = arbitre;
        this.tour = tour;
          // mettre a jour les statistique ( victoire, defaite, match nulle et nombre total des points) de chaque equipe
    	   if(nombreButEquipe1>nombreButEquipe2) {
    			equipe1.incrementVictoires();
    			equipe2.incrementDefaites();
    		}
