...
/*   Veuillez se soutenir de notre rapport pour mettre en evidence l'ensemble de contrainte appliquees a la Competition 
                              et l'explication generale de l'application                                   */
...
public class MaMain {
	...
	public static void main(String[] args)  throws IOException,InterruptedException,FileNotFoundException {
		...
		// La Competition doit etre definit par default avant de pouvoir manipuler notre application 
		...
		int action = 1;
		// Liste de fonctionnalites de l'application selon l'enonce du projet
		while(action > 0) {
    	System.out.println("\nChoisir une action :");
    	System.out.println("1. Effectuer le Test Complet de la Competition"); // donnees deja prets pour un simple test sans passer par saisie au clavier qui est tout a fait possible dans les choix suivants
		...
		case 1: Entraineur entraineur1 = new Entraineur("Solare",42);
		        ...
		        System.out.println("******************************************************************************************************");
		        System.out.println(equipe1.nom + ", " + equipe2.nom + " et " + equipe3.nom + " sont bien enregistres dans " + MaCompetition.nom);
		        ...
		        do {
		        	...
		        	if(equipe4 != null)
		        		System.out.println(nom4 + " est deja enregistre dans la liste des equipes de " + competitionName);
		...
		case 2 : System.out.println("1. Nouveau Joueur");
		       	 System.out.println("2. Mise a jour Maillot Joueur");
			     System.out.println("3. Mise a jour Poste Joueur");
			     System.out.println("4. Mise a jour Equipe Joueur");
			     ...
			     switch (action2) {
			       ...
			       case 1 : 
			    	        ...
			    	        // Verifier si l'equipe existe ou pas dans notre Competition
			    	        Equipe E = MaCompetition.getEquipeByName(temp3);
			    	        if(E == null) {
			    	        	System.out.println("\n-- L'equipe " + temp3 + " n'est pas enregistre dans " + competitionName);
			    	        	// Saisie de l'equipe si elle n'est pas enregistre
			    	        	System.out.println("Saisir le nom d'entraineur de " + temp3);
			    	        	String ent = Sc.nextLine();
			    	        	Entraineur entraineur = MaCompetition.getEntraineurByName(ent);
			    	        	if(entraineur == null) {
			    	        		System.out.println("\n-- " + ent + " n'est pas enregistre dans la liste des entraineurs actifs dans " + competitionName);
			    	        		// Saisie de l'entraineur s'il n'est pas deja enregistre
			    	        		System.out.println("Saisir l'age de  " + ent);
			    	        		int age = Sc.nextInt();
			    	        		Sc.nextLine();
			    	        		entraineur = new Entraineur(ent,age);
			    	        		MaCompetition.addEntraineur(entraineur);
			    	        		System.out.println("\n++ " + ent + " est bien ajoute a la liste des entraineurs actif dans " + competitionName);
			    	        	}
			    	        	E = new Equipe(temp3,entraineur);
			    	        	MaCompetition.addEquipe(E);
			    	        	System.out.println("\n++ " + temp3 + " est bien ajoute aux equipes  actifs dans " + competitionName );
			    	        	entraineur.setEquipe(E);
			    	        	System.out.println("\n++ " + ent + " est bien affecte entraineur a l'equipe " + temp3 );
			    	         }
			    	        	if(E.existeJoueur(temp)) {
			    	        		System.out.println(temp + " est deja enregistre dans l'equipe " + temp3);
			    	        	}
			    	        	else {
			    	        		// Ajout de joueur apres avoir verifier qu'il n'est pas deja enregistre 
					    	        ...
					    	        int nm = Sc.nextInt();
					    	        Sc.nextLine();
					    	        // Verfier l'unicite de numero de maillot et qu'il n'appartient pas a un autre joueur
					    	        while (E.existeNumMaillot(nm)) {
				    	        		System.out.println("Le numero de maillot " + nm + " appratient deja a un autre joueur de " + temp3);
				                    ...
				                    System.out.println("Choisir nomination :\n1.Titulaire \n2.Remplacants ");
	          		                ...
	          		                if(type == 1)
	 	                			  ...
	 	                			  E.addRemplacant(J);
	          		                System.out.println("\n++ " + temp + " est bien ajoute a l'equipe " + temp3 );
			    	        	}
			      ...
			      case 2 : 
	    	        ...
	    	        Joueur j1 = null;
	    	        // Verfier l'existence de l'equipe donnee
	    	        if(et == null) {
	    	        	System.out.println(temp33 + " n'existe pas dans la liste des equipes actifs dans " + competitionName);
	    	        	break;
	    	        }
	    	        else {
	    	        	// Verifier l'existence du joueur donnee
	    	        	...
	    	        	System.out.println(temp11 + " n'existe pas dans la liste des joueurs de " + temp33);
	    	        	  ...
	    	        	  System.out.println("Saisir le nouveau numero de maillot de " + temp33);
		    	        	...
		    	        	if(et.existeNumMaillot(tempnouv)) {
		    	        		// Verfier l'unicite de numero de maillot et qu'il n'appartient pas a un autre joueur
		    	        		System.out.println("Le numero de maillot " + tempnouv + " appratient deja a un autre joueur de " + temp33);
	    	        	  break;
		    	        	}
		    	        	else
			      ...
			      case 3 :
		    	     ...
		    	     // Verfier l'existence de l'equipe donnee
		    	        if(et1 == null) {
		    	        	System.out.println(temp13 + " n'existe pas dans la liste des equipes actifs dans " + competitionName);
		    	        	break;
		    	        }
		    	        else {
	    	     ...
	    	     // Verfier l'existence de l'equipe donnee
	    	        if(et0 == null) {
	    	        	System.out.println(temp30 + " n'existe pas dans la liste des equipes actifs dans " + competitionName);
	    	        }
	    	        else {
		...
		case 3 : 
	        ...
	        Equipe equipe  = MaCompetition.getEquipeByName(nomequipe);;
	        	...
	        	// Verifier l'existence de l'equipe dans la liste des equipes de la competition
	        	if(equipe != null)
	        		System.out.println(nomequipe + " est deja enregistre dans la liste des equipes de " + competitionName);
	        	else {
	    ...
	    case 4: System.out.println("1. Nouveau Entraineur");
	            System.out.println("2. Mise a jour Equipe entraine");
	            ...
	            case 1 : System.out.println("Saisir le nom d'entraineur");
	                     String ent = Sc.nextLine();
	        	         Entraineur entraineur = MaCompetition.getEntraineurByName(ent);
	        	 // Ajout de l'entraineur apres avoir verifier qu'il n'est pas deja enregistre
	        	if(entraineur == null) {
	        		System.out.println("Saisir l'age de " + ent);
	        		int age = Sc.nextInt();
	        		Sc.nextLine();
	        		...
	        		System.out.println(ent + " est deja enregistre a la liste des entraineurs actifs dans " + competitionName);
	        	}
	        	break;
	            ...
	            case 2: System.out.println("Saisir le nom de l'entraineur");
				        ...
				        // Verifier si l'entraineur existe dans la liste des entraineurs enregistres
				        if(entraineurr == null) {
			        		System.out.println("\n-- " + entr + " n'est pas enregistre dans la liste des entraineurs actifs dans " + competitionName);
				        }
				        else {
				        	System.out.println("Saisir le nom de l'equipe a entrainer par " + entr);
				        	String eqp = Sc.nextLine();
				        	Equipe ep = MaCompetition.getEquipeByName(eqp);
				        	if(ep == null)
				        		System.out.println(eqp + " n'existe pas dans la liste des equipes actifs dans " + competitionName);
				        	else {
				        		// Mettre a jour l'equipe entraine et l'objet entraineur dans l'equipe
        ...
        // Verifier si l'arbitre existe deja dans la liste des arbitres enregistres
        if(A == null) {
		System.out.println("Saisir l'age de  " + a);
		int age = Sc.nextInt();
		Sc.nextLine();
		System.out.println("Saisir le nombre de matchs deja deroule par " + a + " s'ils existent");
		int nbMatches = Sc.nextInt();
		Sc.nextLine();
		A = new Arbitre(a,age,nbMatches);
		MaCompetition.addArbitre(A);
		System.out.println("\n++ " + a + " est bien ajoute a la liste des arbitres actif dans " + competitionName);
	} 
        else 
        	System.out.println(a + " est deja enregistre dans la liste des arbitres actifs dans " + competitionName);
		...
		case 6:
			...
			if(p1 == null) {
				// Ajouter l'equipe 1 s'il n'est pas enregistre dans notre base de donnees
	        	System.out.println("\n-- L'equipe " + e1 + " n'est pas enregistre dans " + competitionName);
	        	...
	        	System.out.println("\n++ " + e1 + " est bien ajoute aux equipes  actifs dans " + competitionName );
	        	entraineur.setEquipe(p1);
	        	System.out.println("\n++ " + ent + " est bien affecte entraineur a l'equipe " + e1 );
	         }
			if(p2 == null) {
				// Ajouter l'equipe 2 s'il n'est pas enregistre dans notre base de donnees
	        	System.out.println("\n-- L'equipe " + e2 + " n'est pas enregistre dans " + competitionName);
	        	...
	        	System.out.println("\n++ " + e2 + " est bien ajoute aux equipes  actifs dans " + competitionName );
	        	entraineur.setEquipe(p1);
	        	System.out.println("\n++ " + ent + " est bien affecte entraineur a l'equipe " + e2 );
	         }
			String t = "";
			do {
			...
			Match M = null;
			// Verifier si deux equipes ont deja jouer dans le meme tour ce qui n'est pas possible
			for(int i=0;i<MaCompetition.getMatchs().size();i++) {
				 if(((MaCompetition.getMatchs().get(i).getEquipe1().equals(p1) && MaCompetition.getMatchs().get(i).getEquipe2().equals(p2)) || (MaCompetition.getMatchs().get(i).getEquipe1().equals(p2)&&MaCompetition.getMatchs().get(i).getEquipe2().equals(p1))) && (MaCompetition.getMatchs().get(i).getTour().equals(t))) {
					 System.out.println("Les deux equipes " + p1.nom + " et " + p2.nom + " ont deja jouer en " + t);
					 dejaJoue =true;
					 break;
				 }
			}
			...
			if(t.equals("Retour") && (! dejaJoue)) {
				// Verifier si les deux equipes ont joue le tour Aller si le match en cours de saisie est en tour Retour
				for(int i=0;i<MaCompetition.getMatchs().size();i++) {
			...
			if(! dejaJoue && verifAller && t.equals("Retour"))
				System.out.println("Les deux equipes " + p1.nom + " et " + p2.nom + " n'ont pas encore joue en tour Aller ");
			else if (! dejaJoue && ((verifAller && t.equals("Aller")) || (! verifAller && t.equals("Retour")))) {
				System.out.println("Saisir le nom de l'arbitre");
				String a1 = Sc.nextLine();
				Arbitre A1 = MaCompetition.getArbitreByName(a1);
				// Verifier si l'arbitre existe dans notre base de donnees sinon le defenir
				if(A1 == null) {
		        		System.out.println("\n-- " + a1 + " n'est pas enregistre dans la liste des arbitres actifs dans " + competitionName);
		        		System.out.println("Saisir l'age de  " + a1);
		        		int age = Sc.nextInt();
		        		Sc.nextLine();
		        		System.out.println("Saisir le nombre de matchs deja deroule par Mr. " + a1 + "s'ils existent");
		        		int nbMatches = Sc.nextInt();
		        		Sc.nextLine();
		        		A1 = new Arbitre(a1,age,nbMatches);
		        		MaCompetition.addArbitre(A1);
		        		System.out.println("\n++ " + a1 + " est bien ajoute a la liste des arbitres actif dans " + competitionName);
		        	}
				// Incrementer le nombre de matchs deroules par l'arbitre qui deroule aussi celui dont on saisie
				A1.IncrementNbMatches();
				System.out.println("Saisir le nombre de buts marques par "+ e1);
				int e1b = Sc.nextInt();
				Sc.nextLine();
				System.out.println("Saisir le nombre de buts marques par "+ e2);
				int e2b = Sc.nextInt();
				Sc.nextLine();
		...
		case 7: if(MaCompetition.getMatchs().size()>0)
				...
				System.out.println("Aucun match enregistre dans la competition !");
			    break;
		...
		case 8: System.out.println("Saisir le nom de l'equipe");
		        ...
		        if(eq != null)
		        	...
		        	System.out.println(nomAux + " n'existe pas dans la liste des equipes actifs dans " + competitionName);
		        break;
		 ...
		 case 9: System.out.println("Saisir le nom de l'equipe 1");
		         ...
		         // Verifier l'existence de deux equipes dans la liste de equipes enregistres
		         if(eq1 == null)
		     	 System.out.println(ep1 + " n'existe pas dans la liste des equipes actifs dans " + competitionName);
		         if(eq2 == null)
		     	 System.out.println(ep2 + " n'existe pas dans la liste des equipes actifs dans " + competitionName);
      				  ...
      				  String temp2=scannerAr.next();
       				  String temp3=scannerAr.next();
						  ...
						  MaCompetition.addArbitre(arbitreAux);
						   ...
						   scannerAr.close();
						  System.out.println("Tout va bien :) Les arbitres sont biens lus et enregistres dans votre liste d'arbitres !");
	            	break;
 				    ...
 				    scannerEnt.useDelimiter(",|\\n");
      				  ...
      				  String temp2=scannerEnt.next();
						  ...
						  MaCompetition.addEntraineur(entraineurAux);
						   ...
						   scannerEnt.close();
						  System.out.println("Tout va bien :) Les entraineurs sont biens lus et enregistres dans votre liste d'entraineurs ! !");
	            	break;
					    ...
					    while(scannerEq.hasNext()){
       				  String temp1=scannerEq.next();
						  ...
						  if(temp5.contains("titulaire")){
						   ...
						   scannerEq.close();
						  System.out.println("Tout va bien :) La nouvelle equipe est bien Enregistre !");
					break;
